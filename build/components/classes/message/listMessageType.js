...
exports.default = (to_1, sections_1, ...args_1) => __awaiter(void 0, [to_1, sections_1, ...args_1], void 0, function* (to, sections, header = false, body = false) {
    const standard = {
        header: {
            type: "text",
            text: "Header"
